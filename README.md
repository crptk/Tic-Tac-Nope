...
- The reason I didn't create these originally is because I wanted to see how they would be implimented in my game, to have an idea of how AI works. I asked ChatGPT a bunch of questions to learn
  the ins and outs of this algorithm, and I can confidently say that I know how this algorithm works, and in the future I want to completely recreate the algorithm for this project myself, in order to
